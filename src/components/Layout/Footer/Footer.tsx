          ...
          <div className={`row align-items-center py-4`}>
            <div className={`col-md-7 col-lg-6 text-center text-md-start order-2 order-md-1`}>
              <p className={`d-inline-block text-white mb-0`}>
                ...
                <WdLink href='https://webdimension.gr/' target='_blank' className={`${styles.website} mx-1`}>
                  Κατασκευή Ιστοσελίδας
                </WdLink>

                <WdLink href='https://webdimension.gr/' target='_blank' className={`${styles.webdimension}`}>
                  Webdimension
                </WdLink>
            ...
            <div className={`col-md-5 col-lg-6 text-center text-md-end mb-3 mb-md-0 order-1 order-md-2`}>
              <ul className={`social-icon-style1 ${styles.socialIconUl}`}>
                {/* facebook */}
                <li>
